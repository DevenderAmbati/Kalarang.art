...
import { HiOutlineUserGroup, HiOutlineChatBubbleLeftRight, HiOutlinePaintBrush, HiOutlineCheckBadge, HiOutlineHeart, HiOutlineShoppingBag, HiOutlineSparkles, HiTruck } from 'react-icons/hi2';
