...
const ReauthModal: React.FC<ReauthModalProps> = ({
  ...
  const handlePasswordSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (password.trim() && onPasswordSubmit) {
  ...
  return createPortal(
    <div className="confirm-modal-overlay" onClick={handleOverlayClick}>
      <div className="confirm-modal-content">
        <h2 className="confirm-modal-title">Verify Your Identity</h2>
        ...
        {provider === 'password' ? (
          <>
            ...
            <form onSubmit={handlePasswordSubmit}>
              ...
              <div className="confirm-modal-actions">
                ...
                <button
                  type="submit"
                  className="confirm-modal-btn confirm-modal-btn-confirm confirm-modal-btn-danger"
          ...
          <>
            ...
            <div className="confirm-modal-actions" style={{ marginTop: '2rem' }}>
              <button
                type="button"
                className="confirm-modal-btn confirm-modal-btn-cancel"
                onClick={onClose}
