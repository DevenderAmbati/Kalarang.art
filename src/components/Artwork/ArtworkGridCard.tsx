...
const ArtworkGridCard: React.FC<ArtworkGridCardProps> = ({ 
  ...
  return (
    <div className={`artwork-grid-card ${showMenu ? 'menu-open' : ''} ${noHover ? 'no-hover' : ''}`} onClick={handleCardClick} ref={cardRef}>
          ...
          <div className="artwork-grid-card-actions artwork-actions-engagement">
            ...
            <div className="artwork-actions-right">
              <span className="artwork-stat" title="Saved to favourites">
                ...
                <span className="artwork-stat-num">{artwork.favorites || 0}</span>
              </span>
            </div>
          </div>
        )}
